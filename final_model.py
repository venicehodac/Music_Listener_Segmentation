'''
Amending model_v03.py
- Balancing classes (either w/ balancing class weight or oversampling the underrespresented classes)
- Create report
'''
...
# Re-classify newly sampled data
X_train_2, X_test_2, y_train_2, y_test_2 = train_test_split(X, y, test_size=0.5)
...
classifier_v2.fit(X_train_2, y_train_2)

# Evaluate pipeline performance
print("Random Forest Classifier with Oversampling minority classes:")
print("Performance score:", classifier_v2.score(X_test_2, y_test_2))